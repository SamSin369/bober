    ...
    <main id="main">
        ...
        <header className="showcase">
            ...
            <div className="showcase-content">
                ...
                <div id="landingBtnWrap">
                    <a className="cybr-landing-btn" asp-area="Identity" asp-page="/Account/Register" style={{paddingTop: "10px", paddingBottom: "10px", paddingLeft: "20px", paddingRight: "20px !important"}}>
                        Подать Заявку_ <i className="fas fa-angle-right"></i><span aria-hidden>_</span>
                        <span aria-hidden className="cybr-landing-btn__glitch">Подать Заявку_ <i className="fas fa-angle-right"></i>_ </span>
                    </a>
        ...
        <section className="style-cards">
            ...
            <div className="card-1">
                ...
                <video className="video-1" autoPlay playsInline muted loop><source src={boberContent1} type="video/mp4"/></video>
            </div>
            <div className="card-2">
                <video className="video-2" autoPlay playsInline muted loop><source src={boberContent2}type="video/mp4"/></video>
            ...
            <div className="card-3">
                <div className="desc-3">
                    <h1 className="glower logo-1">Выводи Криптовалюту В Наличные Деньги</h1>
